...
;--------------------------------------------------------
	.area	OSEG    (OVR,DATA)
_ThreadCreate_newThreadID_10001_13	=	0x003b
_ThreadCreate_address_10001_13	=	0x003c
_ThreadCreate_SPtemp_10001_13	=	0x003d
;--------------------------------------------------------
...
;	preemptive.c:105: return -1;
	...
	ret
00102$:
;	preemptive.c:149: __data __at (0x3C) char address = 0;
	mov	_ThreadCreate_address_10001_13,#0x00
;	preemptive.c:150: __data __at (0x3D) char SPtemp = 0;
